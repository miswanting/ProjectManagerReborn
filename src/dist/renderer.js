    ...
    update() {
        ...
        for (let i = 0; i < this.state.data.length; i++) {
            ...
            for (let j = 0; j < line.length; j++) {
                const cell = line[j];
                newLine.push(React.createElement("td", { key: i + ',' + j, onClick: this.handleClick.bind(this, i + ',' + j) },
                    cell,
                    " "));
            }
        ...
        newTableData.push(React.createElement("tr", null,
            React.createElement("td", null),
            React.createElement("td", null,
                React.createElement("button", null, "\u65B0\u589E"))));
        this.setState({
